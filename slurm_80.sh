...
cd /admin/home-jordiclive/peft_open_assistant/Open-AssistantOpen-Assistant/model/model_training/
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed trainer_sft.py --configs defaults oasst_export_eu my-llama-7b --cache_dir /fsx/home-jordiclive/data_cache --output_dir /fsx/home-jordiclive/output_dir --deepspeed --residual_dropout 0.0 --learning_rate 4e-6 --use_flash_attention True --peft_model
