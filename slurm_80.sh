...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed /admin/home-jordiclive/peft_open_assistant/Open-Assistant/model/model_training/trainer_sft.py --configs defaults llama-13b-lora --cache_dir /fsx/home-jordiclive/data_cache --output_dir /fsx/home-jordiclive/peft_models_lora_13b_4/ --deepspeed --residual_dropout 0.0
#CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed /admin/home-jordiclive/peft_open_assistant/Open-Assistant/model/model_training/trainer_sft.py --configs defaults pythia-12B --cache_dir /fsx/home-jordiclive/data_cache --output_dir /fsx/home-jordiclive/peft_models_lora_13b_4/ --deepspeed --residual_dropout 0.0
