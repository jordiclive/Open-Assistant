...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed /admin/home-jordiclive/Open-Assistant/model/model_training/trainer_sft.py --local_rank=0 --configs defaults llama-65b oasst-mix --cache_dir /fsx/home-jordiclive/data_cache --cache_dir /fsx/home-jordiclive/data_cache --output_dir /fsx/home-jordiclive/66B_checkpoints_test/output_dir --deepspeed --residual_dropout 0.0
