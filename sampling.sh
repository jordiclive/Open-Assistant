...
deepspeed --include=localhost:0,1,2,3,4,5,6,7 --master_port 61500 sampling_report_ds2.py --n 248 --model-name OpenAssistant/falcon-40b-lora-sft-1.1k --config config/noprefix2.json --prompts data/prompt_lottery_en_250_text.jsonl --verbose --mode v2_5 --half  2>&1 | tee debug_falcon.txt