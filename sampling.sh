...
deepspeed --include=localhost:0,1,2,3,4,5,6,7 --master_port 61500 sampling_report_ds.py --model-name jordiclive/falcon_lora_40b_ckpt_500_oasst_1_merged --config config/noprefix2.json --prompts data/prompt_lottery_en_250_text.jsonl --verbose --mode v2_5  2>&1 | tee debug_falcon.txt