...
save_adapter(torch_path="/fsx/home-jordiclive/output_dir/checkpoint-8500/pytorch_model.bin",llama_path="/admin/home-jordiclive/llama/7B",adapter_save_path="adapter",dtype=torch.float16)
