...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed /admin/home-jordiclive/Open-Assistant/model/model_training/trainer_sft.py --configs defaults oasst_export_eu llama-7b --cache_dir /fsx/home-jordiclive/data_cache --output_dir /fsx/home-jordiclive/output_dir --residual_dropout 0.2 --deepspeed --num_train_epochs 1 --gradient_accumulation_steps 1 --residual_dropout 0.0 --learning_rate 4e-6 --use_flash_attention True
