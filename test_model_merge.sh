...
python /mnt/data/jordiclive/falcon/Open-Assistant/model/model_training/tools/export_lora_model.py --model_path /mnt/data/llama2/Llama-2-70b-hf-sp-2 --ckpt_path /mnt/data/jordiclive/checkpoint-200 --save_merged_model True --output_dir /mnt/data/jordiclive/falcon/ckpt_200_2  2>&1 | tee debug_falcon.txt
