...
python /mnt/data/jordiclive/falcon/Open-Assistant/model/model_training/tools/export_lora_model.py --model_path /mnt/data/llama2/Llama-2-7b-hf-sp --ckpt_path /mnt/data/jordiclive/falcon/sft_llama70b/checkpoint-10 --save_merged_model True --output_dir /mnt/data/jordiclive/falcon/test  2>&1 | tee debug_falcon.txt
