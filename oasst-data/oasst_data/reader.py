...
def open_jsonl_read(input_file_path: Union[str, Path]) -> TextIO:
...
def read_oasst_obj(line: str) -> Union[ExportMessageTree,ExportMessageNode]:
...
def read_oasst_jsonl(input_file_path: Union[str, Path]) -> Iterable[Union[ExportMessageTree, ExportMessageNode]]:
...
def read_message_trees(input_file_path: Union[str, Path]) -> Iterable[ExportMessageTree]:
...
def read_messages(input_file_path: Union[str, Path]) -> Iterable[ExportMessageNode]:
    for x in read_oasst_jsonl(input_file_path):
