...
deepspeed --include=localhost:2,3,4,5,6,7 --master_port 61000 /mnt/data/jordiclive/Open-Assistant/model/model_training/trainer_sft.py --configs defaults pretrain lora-llama-65b --cache_dir /mnt/data/jordiclive/data_cache --output_dir /mnt/data/jordiclive/65B_ckpts --deepspeed --residual_dropout 0.0 2>&1 | tee debug_30.txt
