source /mnt/data/jordiclive/jordan_qlora/bin/activate
...
CUDA_LAUNCH_BLOCKING=1 deepspeed --include=localhost:0,1 /mnt/data/jordiclive/falcon/Open-Assistant/model/model_training/trainer_sft.py --configs defaults sft-8-datasets llama-7b --cache_dir /mnt/data/jordiclive/data_cache --output_dir /mnt/data/jordiclive/falcon --residual_dropout 0.0 2>&1 | tee debug_30.txt
