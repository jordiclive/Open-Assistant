...
deepspeed --include=localhost:0,1,2,3,4,5,6,7 --master_port 61000 /mnt/data/jordiclive/Open-Assistant/model/model_training/trainer_sft.py --configs defaults pretrain lora-llama-65b-sft --cache_dir /mnt/data/jordiclive/data_cache --output_dir /mnt/data/jordiclive/65B_ckpts_stage3 --deepspeed --residual_dropout 0.0 2>&1 | tee debug_30.txt
